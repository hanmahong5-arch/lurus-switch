# [ARCHIVED] lurus-switch Microservices Development Guide (2024)

> **Status**: ARCHIVED — 已废弃。此文件描述旧微服务开发指南（Hertz + Kratos + NATS + ClickHouse），
> 已被当前 Wails v2 开发指南取代。
> 当前开发指南见 `doc/develop-guide.md`。
