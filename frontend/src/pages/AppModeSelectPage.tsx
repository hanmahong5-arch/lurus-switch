  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-background text-foreground px-6">
      <div className="max-w-3xl w-full">
          ...
          {CHOICES.map(({ id, Icon, iconColor, ringColor }) => {
            ...
            return (
              <Card
                ...
                className={
                  'relative p-6 rounded-xl text-left ring-1 ring-transparent ' + ringColor +
              ...
              >
                ...
                {isLoading && (
                  <div className="absolute inset-0 flex items-center justify-center bg-card-elevated/80 rounded-xl backdrop-blur-sm">
        ...
        {error && (
          <p className="mt-6 text-sm text-red-400 text-center font-mono">{error}</p>
        )}
